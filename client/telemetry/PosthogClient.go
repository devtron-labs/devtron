...
type PosthogConfig struct {
	...
	SummaryCronExpr         string `env:"SUMMARY_CRON_EXPR" envDefault:"0 0 0 * * *"` // Run once a day, midnight
	HeartbeatCronExpr       string `env:"HEARTBEAT_CRON_EXPR" envDefault:"@every 3h"`
