...
func NewTelemetryWatcherImpl(logger *zap.SugaredLogger, client *http.Client, clusterService cluster.ClusterService,
	...
	appListingRepository repository.AppListingRepository) (*TelemetryWatcherImpl, error) {
...
func (impl *TelemetryWatcherImpl) SummeryEventForTelemetry() {
...
func (impl *TelemetryWatcherImpl) HeartbeatEventForTelemetry() {
