...
//GetLatestDevtronArgoCdUserToken(authConfig bean.AcdAuthConfig) (string, error)
...
//	moduleService module.ModuleService,
//	k8sCommonService k8s2.K8sCommonService) (*ArgoUserServiceImpl, error) {
...
//func (impl *ArgoUserServiceImpl) ValidateGitOpsAndGetOrUpdateArgoCdUserDetail(authConfig *bean.AcdAuthConfig) string {
...
//}
//
//func (impl *ArgoUserServiceImpl) GetOrUpdateArgoCdUserDetail(authConfig *bean.AcdAuthConfig) string {
//	token := ""
//	var (
...
//func (impl *ArgoUserServiceImpl) GetLatestDevtronArgoCdUserToken(authConfig bean.AcdAuthConfig) (string, error) {
//	gitOpsConfigurationStatus, err := impl.gitOpsConfigReadService.IsGitOpsConfigured()
//	if err != nil {
...
//	clientConn := impl.argoCDConnectionManager.GetConnectionWithToken(token)
