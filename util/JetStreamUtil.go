...
const (
	...
	AUTO_CD_TRIGGER_TOPIC               string = "AUTO_CD_TRIGGER_TOPIC"
	AUTO_CD_TRIGGER_TOPIC_GROUP         string = "AUTO_CD_TRIGGER_TOPIC_GROUP"
	AUTO_CD_TRIGGER_TOPIC_DURABLE       string = "AUTO_CD_TRIGGER_TOPIC_DURABLE"
)

var ORCHESTRATOR_SUBJECTS = []string{BULK_APPSTORE_DEPLOY_TOPIC, BULK_DEPLOY_TOPIC, BULK_HIBERNATE_TOPIC, CD_SUCCESS, WEBHOOK_EVENT_TOPIC, ARGO_PIPELINE_STATUS_UPDATE_TOPIC, AUTO_CD_TRIGGER_TOPIC, "dummy"}
