...
const (
	...
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_TOPIC   string = "AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE-2"
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_GROUP   string = "AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_GROUP-3"
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_DURABLE string = "AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_DURABLE-3"
)

var ORCHESTRATOR_SUBJECTS = []string{BULK_APPSTORE_DEPLOY_TOPIC, BULK_DEPLOY_TOPIC, BULK_HIBERNATE_TOPIC, CD_SUCCESS, WEBHOOK_EVENT_TOPIC, ARGO_PIPELINE_STATUS_UPDATE_TOPIC, AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_TOPIC}
