...
const (
	...
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_TOPIC   string = "AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE-1"
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_GROUP   string = "AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_GROUP-2"
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_DURABLE string = "AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_DURABLE-2"
)
