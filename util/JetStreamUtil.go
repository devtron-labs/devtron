...
const (
	...
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_TOPIC   string = "AUTO_TRIGGER_CD"
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_GROUP   string = "AUTO_TRIGGER_CD_GROUP"
	AUTO_TRIGGER_STAGES_AFTER_CI_COMPLETE_DURABLE string = "AUTO_TRIGGER_CD_DURABLE"
)
