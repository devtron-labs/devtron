...
|-------|--------------|-------------------|-----------------------|
 ...
 | PG_ADDR | 127.0.0.1 | address of postgres service | postgresql-postgresql.devtroncd | 
 | PG_DATABASE | orchestrator | postgres database to be made connection with | orchestrator, casbin, git_sensor, lens | 
 | PG_EXPORT_PROM_METRICS | true |  |  | 
 | PG_LOG_ALL_FAILURE_QUERIES | true |  |  | 
 | PG_LOG_ALL_QUERY | false |  |  | 
 | PG_LOG_SLOW_QUERY | true |  |  | 
 | PG_PASSWORD |  | password for postgres, associated with PG_USER | confidential ;) | 
 | PG_PORT | 5432 | port of postgresql service | 5432 | 
 | PG_QUERY_DUR_THRESHOLD | 5000 |  |  | 
 | PG_READ_TIMEOUT | 30 |  |  | 
 | PG_USER |  | user for postgres | postgres | 
 | PG_WRITE_TIMEOUT | 30 |  |  | 
