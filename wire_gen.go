...
func InitializeApp() (*App, error) {
	...
	userDeploymentRequestServiceImpl := service2.NewUserDeploymentRequestServiceImpl(userDeploymentRequestRepositoryImpl, pipelineStatusTimelineServiceImpl, sugaredLogger)
