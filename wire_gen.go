...
func InitializeApp() (*App, error) {
	...
	imageDigestQualifierMappingServiceImpl := imageDigestPolicy.NewImageDigestPolicyServiceImpl(sugaredLogger, qualifierMappingServiceImpl, devtronResourceSearchableKeyServiceImpl)
