...
func InitializeApp() (*App, error) {
	...
	configMapHistoryReadServiceImpl := read4.NewConfigMapHistoryReadService(sugaredLogger, configMapHistoryRepositoryImpl, userServiceImpl, scopedVariableCMCSManagerImpl)
