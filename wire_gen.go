...
import (
	...
	repository11 "github.com/devtron-labs/devtron/internal/sql/repository/imageTagging"
...
func InitializeApp() (*App, error) {
	...
	imageTaggingRepositoryImpl := repository11.NewImageTaggingRepositoryImpl(db)
	...
	userAuthImpl := logger.NewUserAuthImpl(userServiceImpl)
	pipelineConfigRouterImpl := router.NewPipelineRouterImpl(pipelineConfigRestHandlerImpl, appWorkflowRestHandlerImpl, webhookDataRestHandlerImpl, pipelineHistoryRestHandlerImpl, pipelineStatusTimelineRestHandlerImpl, userAuthImpl)
	...
	appListingRouterImpl := router.NewAppListingRouterImpl(appListingRestHandlerImpl, userAuthImpl)
	...
	environmentRouterImpl := cluster3.NewEnvironmentRouterImpl(environmentRestHandlerImpl, userAuthImpl)
	...
	clusterRestHandlerImpl := cluster3.NewClusterRestHandlerImpl(clusterServiceImplExtended, genericNoteServiceImpl, clusterDescriptionServiceImpl, sugaredLogger, userServiceImpl, validate, enforcerImpl, deleteServiceExtendedImpl, argoUserServiceImpl, environmentServiceImpl)
	clusterRouterImpl := cluster3.NewClusterRouterImpl(clusterRestHandlerImpl, userAuthImpl)
	...
	userAuthRouterImpl := user2.NewUserAuthRouterImpl(sugaredLogger, userAuthHandlerImpl, userAuthOidcHelperImpl, userAuthImpl)
	...
	applicationRouterImpl := router.NewApplicationRouterImpl(argoApplicationRestHandlerImpl, sugaredLogger, userAuthImpl)
	...
	projectManagementRouterImpl := router.NewProjectManagementRouterImpl(jiraRestHandlerImpl, userAuthImpl)
	...
	gitProviderRouterImpl := router.NewGitProviderRouterImpl(gitProviderRestHandlerImpl, userAuthImpl)
	...
	gitHostRouterImpl := router.NewGitHostRouterImpl(gitHostRestHandlerImpl, userAuthImpl)
	...
	dockerRegRouterImpl := router.NewDockerRegRouterImpl(dockerRegRestHandlerImpl, userAuthImpl)
	...
	notificationRouterImpl := router.NewNotificationRouterImpl(notificationRestHandlerImpl, userAuthImpl)
	...
	teamRouterImpl := team2.NewTeamRouterImpl(teamRestHandlerImpl, userAuthImpl)
	...
	userRouterImpl := user2.NewUserRouterImpl(userRestHandlerImpl, userAuthImpl)
	...
	releaseMetricsRouterImpl := router.NewReleaseMetricsRouterImpl(sugaredLogger, releaseMetricsRestHandlerImpl, userAuthImpl)
	...
	deploymentGroupRouterImpl := router.NewDeploymentGroupRouterImpl(deploymentGroupRestHandlerImpl, userAuthImpl)
	...
	testSuitRouterImpl := router.NewTestSuitRouterImpl(testSuitRestHandlerImpl, userAuthImpl)
	...
	imageScanRouterImpl := router.NewImageScanRouterImpl(imageScanRestHandlerImpl, userAuthImpl)
	...
	dashboardRouterImpl := dashboard.NewDashboardRouterImpl(sugaredLogger, dashboardConfig, userAuthImpl)
	...
	userAttributesRouterImpl := router.NewUserAttributesRouterImpl(userAttributesRestHandlerImpl, userAuthImpl)
	...
	grafanaRouterImpl := router.NewGrafanaRouterImpl(sugaredLogger, grafanaConfig, userAuthImpl)
	...
	ssoLoginRouterImpl := sso2.NewSsoLoginRouterImpl(ssoLoginRestHandlerImpl, userAuthImpl)
	...
	bulkUpdateRouterImpl := router.NewBulkUpdateRouterImpl(bulkUpdateRestHandlerImpl, userAuthImpl)
	...
	coreAppRouterImpl := router.NewCoreAppRouterImpl(coreAppRestHandlerImpl, userAuthImpl)
	...
	helmAppRouterImpl := client3.NewHelmAppRouterImpl(helmAppRestHandlerImpl, userAuthImpl)
	...
	pProfRouterImpl := router.NewPProfRouter(sugaredLogger, pProfRestHandlerImpl, userAuthImpl)
	...
	deploymentConfigRouterImpl := deployment.NewDeploymentRouterImpl(deploymentConfigRestHandlerImpl, userAuthImpl)
	...
	dashboardTelemetryRouterImpl := dashboardEvent.NewDashboardTelemetryRouterImpl(dashboardTelemetryRestHandlerImpl, userAuthImpl)
	...
	commonDeploymentRouterImpl := appStoreDeployment.NewCommonDeploymentRouterImpl(commonDeploymentRestHandlerImpl, userAuthImpl)
	...
	externalLinkRouterImpl := externalLink2.NewExternalLinkRouterImpl(externalLinkRestHandlerImpl, userAuthImpl)
	...
	globalPluginRouterImpl := router.NewGlobalPluginRouter(sugaredLogger, globalPluginRestHandlerImpl, userAuthImpl)
	...
	moduleRouterImpl := module2.NewModuleRouterImpl(moduleRestHandlerImpl, userAuthImpl)
	...
	serverRouterImpl := server2.NewServerRouterImpl(serverRestHandlerImpl, userAuthImpl)
	...
	apiTokenRouterImpl := apiToken2.NewApiTokenRouterImpl(apiTokenRestHandlerImpl, userAuthImpl)
	...
	k8sCapacityRestHandlerImpl := capacity2.NewK8sCapacityRestHandlerImpl(sugaredLogger, k8sCapacityServiceImpl, userServiceImpl, enforcerImpl, clusterServiceImplExtended, environmentServiceImpl)
	k8sCapacityRouterImpl := capacity2.NewK8sCapacityRouterImpl(k8sCapacityRestHandlerImpl, userAuthImpl)
	...
	webhookHelmRouterImpl := webhookHelm2.NewWebhookHelmRouterImpl(webhookHelmRestHandlerImpl, userAuthImpl)
	...
	globalCMCSRouterImpl := router.NewGlobalCMCSRouterImpl(globalCMCSRestHandlerImpl, userAuthImpl)
	...
	userTerminalAccessRouterImpl := terminal2.NewUserTerminalAccessRouterImpl(userTerminalAccessRestHandlerImpl, userAuthImpl)
	jobRouterImpl := router.NewJobRouterImpl(pipelineConfigRestHandlerImpl, appListingRestHandlerImpl, userAuthImpl)
	...
	appGroupingRouterImpl := router.NewAppGroupingRouterImpl(pipelineConfigRestHandlerImpl, appWorkflowRestHandlerImpl, appGroupRestHandlerImpl, userAuthImpl)
	...
	rbacRoleRouterImpl := user2.NewRbacRoleRouterImpl(sugaredLogger, validate, rbacRoleRestHandlerImpl, userAuthImpl)
