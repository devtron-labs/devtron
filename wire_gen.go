...
import (
	...
	repository27 "github.com/devtron-labs/devtron/client/argocdServer/repocreds"
	...
	repository22 "github.com/devtron-labs/devtron/pkg/policyGovernance/security/imageScanning/repository"
	"github.com/devtron-labs/devtron/pkg/policyGovernance/security/scanTool"
	repository9 "github.com/devtron-labs/devtron/pkg/policyGovernance/security/scanTool/repository"
...
func InitializeApp() (*App, error) {
	...
	cvePolicyRepositoryImpl := repository22.NewPolicyRepositoryImpl(db, sugaredLogger)
	imageScanResultRepositoryImpl := repository22.NewImageScanResultRepositoryImpl(db, sugaredLogger)
	imageScanDeployInfoRepositoryImpl := repository22.NewImageScanDeployInfoRepositoryImpl(db, sugaredLogger)
	imageScanObjectMetaRepositoryImpl := repository22.NewImageScanObjectMetaRepositoryImpl(db, sugaredLogger)
	imageScanHistoryRepositoryImpl := repository22.NewImageScanHistoryRepositoryImpl(db, sugaredLogger)
	imageScanHistoryReadServiceImpl := read12.NewImageScanHistoryReadService(sugaredLogger, imageScanHistoryRepositoryImpl)
	cveStoreRepositoryImpl := repository22.NewCveStoreRepositoryImpl(db, sugaredLogger)
	...
	scanToolExecutionHistoryMappingRepositoryImpl := repository22.NewScanToolExecutionHistoryMappingRepositoryImpl(db, sugaredLogger)
	...
	serviceClientImpl2 := repository27.NewServiceClientImpl(sugaredLogger, argoCDConnectionManagerImpl)
