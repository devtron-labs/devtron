...
func InitializeApp() (*App, error) {
	...
	globalTagRestHandlerImpl := globalTag2.NewGlobalTagRestHandlerImpl(sugaredLogger, userServiceImpl, globalTagServiceImpl, enforcerImpl, validate, teamServiceImpl)
