...
import (
	...
	externalLinkout2 "github.com/devtron-labs/devtron/api/externalLinks"
...
func InitializeApp() (*App, error) {
	...
	externalLinksRestHandlerImpl := externalLinkout2.NewExternalLinksRestHandlerImpl(sugaredLogger, externalLinksServiceImpl, userServiceImpl, enforcerImpl, validate, userAuthServiceImpl, deleteServiceExtendedImpl)
	externalLinksRouterImpl := externalLinkout2.NewExternalLinksRouterImpl(externalLinksRestHandlerImpl)
