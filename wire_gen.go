...
func InitializeApp() (*App, error) {
	...
	artifactPromotionDataReadServiceImpl := read3.NewArtifactPromotionDataReadServiceImpl(requestRepositoryImpl, sugaredLogger, requestApprovalUserDataRepositoryImpl, userServiceImpl, pipelineRepositoryImpl, qualifierMappingServiceImpl, globalPolicyDataManagerImpl, appWorkflowDataReadServiceImpl, teamServiceImpl)
	appArtifactManagerImpl := pipeline.NewAppArtifactManagerImpl(sugaredLogger, cdWorkflowRepositoryImpl, userServiceImpl, imageTaggingServiceImpl, ciArtifactRepositoryImpl, ciWorkflowRepositoryImpl, celServiceImpl, resourceFilterServiceImpl, pipelineStageServiceImpl, cdPipelineConfigServiceImpl, dockerArtifactStoreRepositoryImpl, ciPipelineRepositoryImpl, ciTemplateServiceImpl, imageTaggingRepositoryImpl, artifactApprovalDataReadServiceImpl, environmentRepositoryImpl, appWorkflowRepositoryImpl, artifactPromotionDataReadServiceImpl, teamServiceImpl, appWorkflowDataReadServiceImpl)
	...
	appWorkflowRestHandlerImpl := workflow.NewAppWorkflowRestHandlerImpl(sugaredLogger, userServiceImpl, appWorkflowServiceImpl, teamServiceImpl, enterpriseEnforcerImpl, pipelineBuilderImpl, appRepositoryImpl, enforcerUtilImpl, appArtifactManagerImpl)
	...
	promotionPolicyServiceImpl := artifactPromotion.NewPromotionPolicyServiceImpl(globalPolicyDataManagerImpl, cdPipelineConfigServiceImpl, sugaredLogger, transactionUtilImpl)
	approvalRequestServiceImpl := artifactPromotion.NewApprovalRequestServiceImpl(requestRepositoryImpl, sugaredLogger, ciPipelineRepositoryImpl, pipelineRepositoryImpl, userServiceImpl, ciArtifactRepositoryImpl, appWorkflowRepositoryImpl, cdWorkflowRepositoryImpl, resourceFilterEvaluatorImpl, imageTaggingServiceImpl, artifactPromotionDataReadServiceImpl, requestApprovalUserDataRepositoryImpl, workflowDagExecutorImpl, promotionPolicyServiceImpl, pipelineStageServiceImpl, environmentServiceImpl, filterEvaluationAuditServiceImpl, transactionUtilImpl)
	restHandlerImpl := artifactPromotionApprovalRequest.NewRestHandlerImpl(approvalRequestServiceImpl, sugaredLogger, userServiceImpl, validate, userCommonServiceImpl, enforcerUtilImpl, environmentServiceImpl, appArtifactManagerImpl, enterpriseEnforcerImpl)
	...
	mainApp := NewApp(muxRouter, sugaredLogger, sseSSE, syncedEnforcer, casbinSyncedEnforcer, db, pubSubClientServiceImpl, sessionManager, posthogClient, loggingMiddlewareImpl, userServiceImpl, centralEventProcessor)
	return mainApp, nil
}
