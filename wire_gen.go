...
func InitializeApp() (*App, error) {
	...
	buildPipelineConfigServiceImpl := pipeline.NewBuildPipelineConfigServiceImpl(sugaredLogger, ciCdPipelineOrchestratorImpl, dockerArtifactStoreRepositoryImpl, materialRepositoryImpl, appRepositoryImpl, pipelineRepositoryImpl, ciPipelineRepositoryImpl, ciArtifactRepositoryImpl, ecrConfig, appWorkflowRepositoryImpl, ciCdConfig, cdWorkflowRepositoryImpl, ciPipelineMaterialRepositoryImpl, userServiceImpl, ciTemplateServiceImpl, gitMaterialHistoryServiceImpl, ciTemplateHistoryServiceImpl, ciWorkflowRepositoryImpl, resourceGroupServiceImpl, imageTaggingServiceImpl, attributesServiceImpl, pipelineStageServiceImpl, enforcerUtilImpl, ciTemplateOverrideRepositoryImpl)
	propertiesConfigServiceImpl := pipeline.NewPropertiesConfigServiceImpl(sugaredLogger, envConfigOverrideRepositoryImpl, chartRepositoryImpl, chartRefRepositoryImpl, utilMergeUtil, environmentRepositoryImpl, ciCdPipelineOrchestratorImpl, applicationServiceClientImpl, envLevelAppMetricsRepositoryImpl, appLevelMetricsRepositoryImpl, deploymentTemplateHistoryServiceImpl, variableEntityMappingServiceImpl, variableTemplateParserImpl)
	...
	deploymentPipelineConfigServiceImpl := pipeline.NewDeploymentPipelineConfigServiceImpl(sugaredLogger, ciCdPipelineOrchestratorImpl, appServiceImpl, appRepositoryImpl, pipelineRepositoryImpl, propertiesConfigServiceImpl, ciPipelineRepositoryImpl, applicationServiceClientImpl, chartRepositoryImpl, environmentRepositoryImpl, clusterRepositoryImpl, pipelineConfigRepositoryImpl, appWorkflowRepositoryImpl, gitOpsConfigRepositoryImpl, pipelineStrategyHistoryServiceImpl, prePostCdScriptHistoryServiceImpl, deploymentTemplateHistoryServiceImpl, appLevelMetricsRepositoryImpl, pipelineStageServiceImpl, chartTemplateServiceImpl, helmAppServiceImpl, deploymentGroupRepositoryImpl, globalStrategyMetadataChartRefMappingRepositoryImpl, pipelineDeploymentServiceTypeConfig, appStatusRepositoryImpl, workflowDagExecutorImpl, enforcerUtilImpl, resourceGroupServiceImpl, chartDeploymentServiceImpl, attributesRepositoryImpl, variableEntityMappingServiceImpl, variableTemplateParserImpl, buildPipelineConfigServiceImpl)
	appConfigServiceImpl := pipeline.NewAppConfigServiceImpl(sugaredLogger, ciCdPipelineOrchestratorImpl, appRepositoryImpl, pipelineRepositoryImpl, enforcerUtilImpl, resourceGroupServiceImpl, buildPipelineConfigServiceImpl)
	pipelineBuilderImpl := pipeline.NewPipelineBuilderImpl(buildPipelineConfigServiceImpl, deploymentPipelineConfigServiceImpl, appConfigServiceImpl, sugaredLogger)
	dbMigrationServiceImpl := pipeline.NewDbMogrationService(sugaredLogger, dbMigrationConfigRepositoryImpl)
	ciServiceImpl := pipeline.NewCiServiceImpl(sugaredLogger, workflowServiceImpl, ciPipelineMaterialRepositoryImpl, ciWorkflowRepositoryImpl, eventRESTClientImpl, eventSimpleFactoryImpl, mergeUtil, ciPipelineRepositoryImpl, prePostCiScriptHistoryServiceImpl, pipelineStageServiceImpl, userServiceImpl, ciTemplateServiceImpl, appCrudOperationServiceImpl, environmentRepositoryImpl, appRepositoryImpl, variableSnapshotHistoryServiceImpl)
