...
import (
	...
	repository8 "github.com/devtron-labs/devtron/pkg/variables/repository"
...
func InitializeApp() (*App, error) {
	...
	variableSnapshotHistoryRepositoryImpl := repository8.NewVariableSnapshotHistoryRepository(sugaredLogger, db)
