...
import (
	...
	read17 "github.com/devtron-labs/devtron/pkg/argoApplication/read"
	...
	read13 "github.com/devtron-labs/devtron/pkg/build/artifacts/imageTagging/read"
	"github.com/devtron-labs/devtron/pkg/build/git/gitHost"
	read16 "github.com/devtron-labs/devtron/pkg/build/git/gitHost/read"
	repository25 "github.com/devtron-labs/devtron/pkg/build/git/gitHost/repository"
	read11 "github.com/devtron-labs/devtron/pkg/build/git/gitMaterial/read"
	...
	read10 "github.com/devtron-labs/devtron/pkg/build/pipeline/read"
	...
	read9 "github.com/devtron-labs/devtron/pkg/config/read"
	...
	read12 "github.com/devtron-labs/devtron/pkg/deployment/manifest/configMapAndSecret/read"
	...
	read14 "github.com/devtron-labs/devtron/pkg/policyGovernance/security/imageScanning/read"
...
func InitializeApp() (*App, error) {
	...
	configReadServiceImpl := read9.NewConfigReadServiceImpl(sugaredLogger, commonServiceImpl, configMapRepositoryImpl, mergeUtil, scopedVariableCMCSManagerImpl)
	...
	ciPipelineConfigReadServiceImpl := read10.NewCiPipelineConfigReadServiceImpl(sugaredLogger, ciPipelineRepositoryImpl, ciTemplateOverrideRepositoryImpl)
	...
	gitMaterialReadServiceImpl := read11.NewGitMaterialReadServiceImpl(sugaredLogger, materialRepositoryImpl)
	...
	configMapHistoryReadServiceImpl := read12.NewConfigMapHistoryReadService(sugaredLogger, configMapHistoryRepositoryImpl, scopedVariableCMCSManagerImpl)
	deploymentTemplateHistoryReadServiceImpl := read7.NewDeploymentTemplateHistoryReadServiceImpl(sugaredLogger, deploymentTemplateHistoryRepositoryImpl, scopedVariableManagerImpl, pipelineStrategyHistoryServiceImpl, cdWorkflowRepositoryImpl, configMapHistoryReadServiceImpl)
	deploymentTemplateHistoryServiceImpl := deploymentTemplate.NewDeploymentTemplateHistoryServiceImpl(sugaredLogger, deploymentTemplateHistoryRepositoryImpl, pipelineRepositoryImpl, chartRepositoryImpl, userServiceImpl, cdWorkflowRepositoryImpl, scopedVariableManagerImpl, deployedAppMetricsServiceImpl, chartRefServiceImpl, pipelineStrategyHistoryServiceImpl, configMapHistoryServiceImpl, deploymentTemplateHistoryReadServiceImpl, configMapHistoryReadServiceImpl)
	...
	imageTaggingReadServiceImpl, err := read13.NewImageTaggingReadServiceImpl(imageTaggingRepositoryImpl, sugaredLogger)
	if err != nil {
		return nil, err
	}
	...
	imageScanHistoryReadServiceImpl := read14.NewImageScanHistoryReadService(sugaredLogger, imageScanHistoryRepositoryImpl)
	...
	imageScanResultReadServiceImpl := read14.NewImageScanResultReadServiceImpl(sugaredLogger, imageScanResultRepositoryImpl)
	...
	imageScanDeployInfoReadServiceImpl := read14.NewImageScanDeployInfoReadService(sugaredLogger, imageScanDeployInfoRepositoryImpl)
	...
	gitHostReadServiceImpl := read16.NewGitHostReadServiceImpl(sugaredLogger, gitHostRepositoryImpl, attributesServiceImpl)
	...
	pipelineHistoryRestHandlerImpl := history2.NewPipelineHistoryRestHandlerImpl(sugaredLogger, userServiceImpl, enforcerImpl, pipelineStrategyHistoryServiceImpl, configMapHistoryServiceImpl, prePostCiScriptHistoryServiceImpl, prePostCdScriptHistoryServiceImpl, enforcerUtilImpl, deploymentTemplateHistoryReadServiceImpl)
	...
	argoApplicationReadServiceImpl := read17.NewArgoApplicationReadServiceImpl(sugaredLogger, clusterRepositoryImpl, k8sServiceImpl, helmAppClientImpl, helmAppServiceImpl)
	...
	deploymentHistoryServiceImpl := cdPipeline.NewDeploymentHistoryServiceImpl(sugaredLogger, cdHandlerImpl, imageTaggingReadServiceImpl, imageTaggingServiceImpl, deploymentTemplateHistoryReadServiceImpl)
