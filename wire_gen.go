...
func InitializeApp() (*App, error) {
	...
	imageTaggingServiceImpl := pipeline.NewImageTaggingServiceImpl(imageTaggingRepositoryImpl, ciPipelineRepositoryImpl, environmentRepositoryImpl, sugaredLogger)
