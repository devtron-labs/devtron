...
func InitializeApp() (*App, error) {
	...
	scopedVariableRepositoryImpl := repository12.NewScopedVariableRepository(db, sugaredLogger)
	...
	variableEntityMappingRepositoryImpl := repository12.NewVariableEntityMappingRepository(sugaredLogger, db)
