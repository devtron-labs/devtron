...
func InitializeApp() (*App, error) {
	...
	configDraftServiceImpl := drafts.NewConfigDraftServiceImpl(sugaredLogger, configDraftRepositoryImpl, chartServiceImpl, propertiesConfigServiceImpl)
