...
func InitializeApp() (*App, error) {
	...
	restHandlerImpl := artifactPromotionApprovalRequest.NewRestHandlerImpl(artifactPromotionApprovalServiceImpl, sugaredLogger, userServiceImpl, validate, userCommonServiceImpl, enforcerUtilImpl, environmentRepositoryImpl, artifactPromotionApprovalRequestRepoImpl, appArtifactManagerImpl)
