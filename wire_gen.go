...
func InitializeApp() (*App, error) {
	...
	pipelineStatusFetchDetailRepositoryImpl := pipelineConfig.NewPipelineStatusSyncDetailRepositoryImpl(db, sugaredLogger)
	pipelineStatusFetchDetailServiceImpl := app2.NewPipelineStatusSyncDetailServiceImpl(sugaredLogger, pipelineStatusFetchDetailRepositoryImpl)
