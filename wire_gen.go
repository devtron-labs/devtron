...
func InitializeApp() (*App, error) {
	...
	artifactPromotionApprovalRequestRepoImpl := repository20.NewArtifactPromotionApprovalRequestImpl(db)
	...
	promotionPolicyServiceImpl := artifactPromotion.NewPromotionPolicyServiceImpl(globalPolicyDataManagerImpl, qualifierMappingServiceImpl, cdPipelineConfigServiceImpl, sugaredLogger)
	artifactPromotionApprovalServiceImpl := artifactPromotion.NewArtifactPromotionApprovalServiceImpl(artifactPromotionApprovalRequestRepoImpl, sugaredLogger, ciPipelineRepositoryImpl, pipelineRepositoryImpl, userServiceImpl, ciArtifactRepositoryImpl, appWorkflowRepositoryImpl, cdWorkflowRepositoryImpl, resourceFilterEvaluatorImpl, imageTaggingServiceImpl, artifactPromotionDataReadServiceImpl, requestApprovalUserDataRepositoryImpl, workflowDagExecutorImpl, promotionPolicyServiceImpl, pipelineStageServiceImpl, environmentServiceImpl, filterEvaluationAuditServiceImpl)
	restHandlerImpl := artifactPromotionApprovalRequest.NewRestHandlerImpl(artifactPromotionApprovalServiceImpl, sugaredLogger, userServiceImpl, validate, userCommonServiceImpl, enforcerUtilImpl, environmentRepositoryImpl, artifactPromotionApprovalRequestRepoImpl, appArtifactManagerImpl, enterpriseEnforcerImpl)
