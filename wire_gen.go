...
func InitializeApp() (*App, error) {
	...
	ciStatusUpdateCronConfig, err := cron.GetCiStatusUpdateCronConfig()
	if err != nil {
		return nil, err
	}
	ciStatusUpdateCronImpl := cron.NewCiStatusUpdateCronImpl(sugaredLogger, appServiceImpl, ciStatusUpdateCronConfig, ciPipelineRepositoryImpl)
