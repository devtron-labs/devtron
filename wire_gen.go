...
func InitializeApp() (*App, error) {
	...
	artifactPromotionDataReadServiceImpl := read2.NewArtifactPromotionDataReadServiceImpl(requestRepositoryImpl, sugaredLogger, requestApprovalUserDataRepositoryImpl, userServiceImpl, pipelineRepositoryImpl, qualifierMappingServiceImpl, globalPolicyDataManagerImpl)
	...
	restHandlerImpl := artifactPromotionApprovalRequest.NewRestHandlerImpl(approvalRequestServiceImpl, sugaredLogger, userServiceImpl, validate, userCommonServiceImpl, enforcerUtilImpl, environmentRepositoryImpl, requestRepositoryImpl, appArtifactManagerImpl, enterpriseEnforcerImpl)
