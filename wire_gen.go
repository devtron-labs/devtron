...
import (
	...
	repository23 "github.com/devtron-labs/devtron/pkg/autoRemediation/repository"
	...
	repository21 "github.com/devtron-labs/devtron/pkg/policyGovernance/artifactPromotion/repository"
...
func InitializeApp() (*App, error) {
	...
	moduleCacheServiceImpl, err := module.NewModuleCacheServiceImpl(sugaredLogger, k8sUtilExtended, moduleEnvConfig, serverEnvConfigServerEnvConfig, serverDataStoreServerDataStore, moduleRepositoryImpl, teamServiceImpl)
	if err != nil {
		return nil, err
	}
	...
	appCrudOperationServiceEnterpriseImpl := app3.NewAppCrudOperationServiceEnterpriseImpl(appLabelRepositoryImpl, sugaredLogger, appRepositoryImpl, userRepositoryImpl, installedAppRepositoryImpl, globalTagServiceImpl, teamRepositoryImpl, genericNoteServiceImpl, materialRepositoryImpl, installedAppDBServiceImpl)
	...
	configDraftServiceImpl := drafts.NewConfigDraftServiceImpl(sugaredLogger, configDraftRepositoryImpl, configMapServiceImpl, chartServiceImpl, propertiesConfigServiceImpl, resourceProtectionServiceImpl, userServiceImpl, appRepositoryImpl, environmentRepositoryImpl, chartRepositoryImpl, lockConfigurationServiceImpl, envConfigOverrideRepositoryImpl, utilMergeUtil, eventSimpleFactoryImpl, eventRESTClientImpl, deploymentTemplateValidationServiceImpl, globalAuthorisationConfigServiceImpl)
	...
	proxyRouterImpl, err := proxy.NewProxyRouterImpl(sugaredLogger, proxyConfig, enterpriseEnforcerImpl)
	if err != nil {
		return nil, err
	}
	...
	k8sEventWatcherRepositoryImpl := repository23.NewWatcherRepositoryImpl(db, sugaredLogger)
	triggerRepositoryImpl := repository23.NewTriggerRepositoryImpl(db, sugaredLogger)
	interceptedEventsRepositoryImpl := repository23.NewInterceptedEventsRepositoryImpl(db, sugaredLogger)
	...
	scoopRestHandlerImpl := scoop2.NewRestHandler(scoopServiceImpl, watcherServiceImpl, enforcerUtilImpl, userServiceImpl, sugaredLogger, enterpriseEnforcerImpl, ciCdConfig, environmentServiceImpl)
