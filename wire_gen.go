...
func InitializeApp() (*App, error) {
	...
	pluginRepositoryImpl := repository.NewPluginRepositoryImpl(db, sugaredLogger)
	pluginRestHandlerImpl := restHandler.NewPluginRestHandlerImpl(serviceClientImpl, sugaredLogger, pluginRepositoryImpl)
	pluginRouterImpl := router.NewPluginRouterImpl(pluginRestHandlerImpl)
