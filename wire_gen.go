...
import (
	...
	repository22 "github.com/devtron-labs/devtron/client/argocdServer/repository"
	...
	repository20 "github.com/devtron-labs/devtron/internal/sql/repository/imageTagging"
	...
	repository18 "github.com/devtron-labs/devtron/pkg/build/git/gitMaterial/repository"
	...
	repository21 "github.com/devtron-labs/devtron/pkg/build/git/gitWebhook/repository"
	...
	repository19 "github.com/devtron-labs/devtron/pkg/pipeline/history/repository"
	"github.com/devtron-labs/devtron/pkg/pipeline/infraProviders"
	repository16 "github.com/devtron-labs/devtron/pkg/pipeline/repository"
	"github.com/devtron-labs/devtron/pkg/pipeline/types"
	"github.com/devtron-labs/devtron/pkg/plugin"
	repository17 "github.com/devtron-labs/devtron/pkg/plugin/repository"
...
func InitializeApp() (*App, error) {
	...
	pipelineStageRepositoryImpl := repository16.NewPipelineStageRepository(sugaredLogger, db)
	globalPluginRepositoryImpl := repository17.NewGlobalPluginRepository(sugaredLogger, db)
	...
	materialRepositoryImpl := repository18.NewMaterialRepositoryImpl(db)
	...
	prePostCdScriptHistoryRepositoryImpl := repository19.NewPrePostCdScriptHistoryRepositoryImpl(sugaredLogger, db)
	configMapHistoryRepositoryImpl := repository19.NewConfigMapHistoryRepositoryImpl(sugaredLogger, db, transactionUtilImpl)
	...
	gitMaterialHistoryRepositoryImpl := repository19.NewGitMaterialHistoryRepositoyImpl(db)
	gitMaterialHistoryServiceImpl := history.NewGitMaterialHistoryServiceImpl(gitMaterialHistoryRepositoryImpl, sugaredLogger)
	ciPipelineHistoryRepositoryImpl := repository19.NewCiPipelineHistoryRepositoryImpl(db, sugaredLogger)
	...
	deploymentTemplateHistoryRepositoryImpl := repository19.NewDeploymentTemplateHistoryRepositoryImpl(sugaredLogger, db)
	...
	imageTaggingRepositoryImpl := repository20.NewImageTaggingRepositoryImpl(db, transactionUtilImpl)
	...
	gitWebhookRepositoryImpl := repository21.NewGitWebhookRepositoryImpl(db)
	...
	ciTemplateHistoryRepositoryImpl := repository19.NewCiTemplateHistoryRepositoryImpl(db, sugaredLogger)
	...
	pipelineStrategyHistoryRepositoryImpl := repository19.NewPipelineStrategyHistoryRepositoryImpl(sugaredLogger, db)
	...
	cvePolicyRepositoryImpl := repository9.NewPolicyRepositoryImpl(db)
	...
	manifestPushConfigRepositoryImpl := repository16.NewManifestPushConfigRepository(sugaredLogger, db)
	...
	prePostCiScriptHistoryRepositoryImpl := repository19.NewPrePostCiScriptHistoryRepositoryImpl(sugaredLogger, db)
