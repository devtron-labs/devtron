...
func InitializeApp() (*App, error) {
	...
	promotionPolicyServiceImpl := artifactPromotion.NewPromotionPolicyServiceImpl(globalPolicyDataManagerImpl, cdPipelineConfigServiceImpl, sugaredLogger, qualifierMappingServiceImpl, transactionUtilImpl)
