...
func InitializeApp() (*App, error) {
	...
	helmUserRepositoryImpl := user.NewHelmUserRepositoryImpl(db, sugaredLogger)
	helmUserRoleRepositoryImpl := user.NewHelmUserRoleRepositoryImpl(db, sugaredLogger)
	helmUserUtilImpl := user.NewHelmUserUtilImpl(sugaredLogger, helmUserRepositoryImpl, helmUserRoleRepositoryImpl, sessionManager)
	helmUserServiceImpl := user.NewHelmUserServiceImpl(sugaredLogger, helmUserRepositoryImpl, helmUserRoleRepositoryImpl, sessionManager, helmUserUtilImpl)
	helmUserRoleGroupRepositoryImpl := user.NewHelmUserRoleGroupRepositoryImpl(db, sugaredLogger)
	helmUserRoleGroupServiceImpl := user.NewHelmUserRoleGroupServiceImpl(helmUserRoleRepositoryImpl, sugaredLogger, helmUserRepositoryImpl, helmUserRoleGroupRepositoryImpl)
	helmUserRestHandlerImpl := user2.NewHelmUserRestHandlerImpl(helmUserServiceImpl, validate, sugaredLogger, helmUserRoleGroupServiceImpl)
	helmUserRouterImpl := user2.NewHelmUserRouterImpl(helmUserRestHandlerImpl, argoCDSettings)
