...
func InitializeApp() (*App, error) {
	...
	imageTaggingRepositoryImpl := repository18.NewImageTaggingRepositoryImpl(db)
	...
	configMapHistoryRepositoryImpl := repository13.NewConfigMapHistoryRepositoryImpl(sugaredLogger, db)
