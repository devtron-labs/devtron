...
import (
	...
	read3 "github.com/devtron-labs/devtron/pkg/build/artifacts/imageTagging/read"
...
func InitializeApp() (*App, error) {
	...
	imageTaggingRepositoryImpl := repository13.NewImageTaggingRepositoryImpl(db, transactionUtilImpl)
	imageTaggingReadServiceImpl, err := read3.NewImageTaggingReadServiceImpl(imageTaggingRepositoryImpl, sugaredLogger)
	if err != nil {
		return nil, err
	}
	...
	devtronAppAutoCompleteRestHandlerImpl := pipeline3.NewDevtronAppAutoCompleteRestHandlerImpl(sugaredLogger, userServiceImpl, teamServiceImpl, enforcerImpl, enforcerUtilImpl, devtronAppConfigServiceImpl, environmentServiceImpl, gitRegistryConfigImpl, dockerRegistryConfigImpl)
