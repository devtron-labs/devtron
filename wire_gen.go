...
import (
	...
	terminal3 "github.com/devtron-labs/devtron/internal/sql/repository/terminal"
...
func InitializeApp() (*App, error) {
	...
	terminalAccessRepositoryImpl := terminal3.NewTerminalAccessRepositoryImpl(db, sugaredLogger)
