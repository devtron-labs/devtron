...
func InitializeApp() (*App, error) {
	...
	watcherServiceImpl := autoRemediation.NewWatcherServiceImpl(watcherRepositoryImpl, triggerRepositoryImpl, interceptedEventsRepositoryImpl, appRepositoryImpl, ciPipelineRepositoryImpl, environmentRepositoryImpl, appWorkflowRepositoryImpl, clusterRepositoryImpl, qualifierMappingServiceImpl, k8sApplicationServiceImpl, sugaredLogger)
	scoopServiceImpl := scoop.NewServiceImpl(sugaredLogger, watcherServiceImpl, ciHandlerImpl, ciPipelineMaterialRepositoryImpl, interceptedEventsRepositoryImpl)
	scoopRestHandlerImpl := scoop.NewRestHandler(scoopServiceImpl, watcherServiceImpl)
