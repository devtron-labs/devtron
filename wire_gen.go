...
import (
	...
	read10 "github.com/devtron-labs/devtron/pkg/build/artifacts/imageTagging/read"
	...
	read9 "github.com/devtron-labs/devtron/pkg/build/git/gitMaterial/read"
...
func InitializeApp() (*App, error) {
	...
	dockerRegistryIpsConfigServiceImpl := dockerRegistry.NewDockerRegistryIpsConfigServiceImpl(sugaredLogger, dockerRegistryIpsConfigRepositoryImpl, k8sServiceImpl, ciPipelineRepositoryImpl, dockerArtifactStoreRepositoryImpl, ciTemplateOverrideRepositoryImpl, clusterReadServiceImpl)
	...
	gitMaterialReadServiceImpl := read9.NewGitMaterialReadServiceImpl(sugaredLogger, materialRepositoryImpl)
	...
	imageTaggingReadServiceImpl, err := read10.NewImageTaggingReadServiceImpl(imageTaggingRepositoryImpl, sugaredLogger)
	if err != nil {
		return nil, err
	}
	...
	ciPipelineConfigReadServiceImpl := read11.NewCiPipelineConfigReadServiceImpl(sugaredLogger, ciPipelineRepositoryImpl)
