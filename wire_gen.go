...
func InitializeApp() (*App, error) {
	...
	appStoreValidatorImpl := service3.NewAppAppStoreValidatorImpl(sugaredLogger)
	...
	deletePostProcessorImpl := service3.NewDeletePostProcessorImpl(sugaredLogger)
	...
	helmAppRestHandlerImpl := client3.NewHelmAppRestHandlerImpl(sugaredLogger, helmAppServiceImpl, enforcerImpl, clusterServiceImplExtended, enforcerUtilHelmImpl, appStoreDeploymentServiceImpl, installedAppDBServiceImpl, userServiceImpl, attributesServiceImpl, serverEnvConfigServerEnvConfig, environmentVariables)
