...
func InitializeApp() (*App, error) {
	...
	pipelineStatusFetchDetailRepositoryImpl := pipelineConfig.NewPipelineStatusFetchDetailRepositoryImpl(db, sugaredLogger)
	pipelineStatusFetchDetailServiceImpl := app2.NewPipelineStatusFetchDetailServiceImpl(sugaredLogger, pipelineStatusFetchDetailRepositoryImpl)
	pipelineStatusTimelineServiceImpl := app2.NewPipelineStatusTimelineServiceImpl(sugaredLogger, pipelineStatusTimelineRepositoryImpl, cdWorkflowRepositoryImpl, userServiceImpl, pipelineStatusTimelineResourcesServiceImpl, pipelineStatusFetchDetailServiceImpl)
	...
	externalCiRestHandlerImpl := restHandler.NewExternalCiRestHandlerImpl(sugaredLogger, webhookServiceImpl, ciEventHandlerImpl, validate, userServiceImpl)
	...
	userTerminalAccessServiceImpl, err := clusterTerminalAccess.NewUserTerminalAccessServiceImpl(sugaredLogger, terminalAccessRepositoryImpl, k8sApplicationServiceImpl, k8sClientServiceImpl, terminalSessionHandlerImpl)
	if err != nil {
		return nil, err
	}
