...
func InitializeApp() (*App, error) {
	...
	defaultRbacPolicyDataRepositoryImpl := repository4.NewDefaultRbacPolicyDataRepositoryImpl(sugaredLogger, db)
	defaultRbacRoleDataRepositoryImpl := repository4.NewDefaultRbacRoleDataRepositoryImpl(sugaredLogger, db)
	defaultRbacDataCacheFactoryImpl := repository4.NewDefaultRbacDataCacheFactoryImpl(sugaredLogger, defaultRbacPolicyDataRepositoryImpl, defaultRbacRoleDataRepositoryImpl)
