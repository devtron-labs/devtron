...
func InitializeApp() (*App, error) {
	...
	scoopServiceImpl := scoop.NewServiceImpl(sugaredLogger, watcherServiceImpl, ciHandlerImpl, ciPipelineMaterialRepositoryImpl, interceptedEventsRepositoryImpl, clusterServiceImplExtended, eventRESTClientImpl, eventSimpleFactoryImpl)
	scoopRestHandlerImpl := scoop.NewRestHandler(scoopServiceImpl, watcherServiceImpl, enforcerUtilImpl, enterpriseEnforcerImpl)
