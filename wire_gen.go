...
func InitializeApp() (*App, error) {
	...
	kubeCapacityRestHandlerImpl := restHandler.NewKubeCapacityRestHandlerImpl(sugaredLogger)
	kubeCapacityRouterImpl := router.NewKubeCapacityRouterImpl(kubeCapacityRestHandlerImpl)
