...
func InitializeApp() (*App, error) {
	...
	deploymentConfigServiceImpl := common.NewDeploymentConfigServiceImpl(repositoryImpl, sugaredLogger, chartRepositoryImpl, pipelineRepositoryImpl, gitOpsConfigReadServiceImpl)
