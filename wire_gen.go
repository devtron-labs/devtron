...
func InitializeApp() (*App, error) {
	...
	chartProviderServiceImpl := chartProvider.NewChartProviderServiceImpl(sugaredLogger, chartRepoRepositoryImpl, dockerArtifactStoreRepositoryImpl, ociRegistryConfigRepositoryImpl)
