...
func InitializeApp() (*App, error) {
	...
	cicdRepositoryImpl := repository.NewCicdRepositoryImpl(db, sugaredLogger)
	cicdRestHandlerImpl := restHandler.NewCicdRestHandlerImpl(serviceClientImpl, sugaredLogger, cicdRepositoryImpl)
	cicdRouterImpl := router.NewCicdRouterImpl(cicdRestHandlerImpl)
