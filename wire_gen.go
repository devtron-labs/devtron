...
func InitializeApp() (*App, error) {
	...
	appWorkflowServiceImpl := appWorkflow2.NewAppWorkflowServiceImpl(sugaredLogger, appWorkflowRepositoryImpl, ciCdPipelineOrchestratorEnterpriseImpl, ciPipelineRepositoryImpl, pipelineRepositoryImpl, enforcerUtilImpl, resourceGroupServiceImpl, appRepositoryImpl, userAuthServiceImpl, chartServiceImpl)
	...
	resourceScanResultRepositoryImpl := security.NewResourceScanResultRepositoryImpl(db, sugaredLogger)
	serviceImpl := scanningResultsParser.NewServiceImpl(cdWorkflowRepositoryImpl, ciArtifactRepositoryImpl, imageScanDeployInfoRepositoryImpl, imageScanHistoryRepositoryImpl, resourceScanResultRepositoryImpl, sugaredLogger)
	...
	chartScanEventProcessorImpl := in.NewChartScanEventProcessorImpl(sugaredLogger, pubSubClientServiceImpl, helmAppServiceImpl, policyServiceImpl, imageScanDeployInfoRepositoryImpl, imageScanHistoryRepositoryImpl)
