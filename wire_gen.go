...
import (
	...
	repository10 "github.com/devtron-labs/devtron/internal/sql/repository/imageTagging"
...
func InitializeApp() (*App, error) {
	...
	manifestPushConfigRepositoryImpl := repository8.NewManifestPushConfigRepository(sugaredLogger, db)
	...
	cdWorkflowServiceImpl, err := pipeline.NewCdWorkflowServiceImpl(sugaredLogger, environmentRepositoryImpl, cdConfig, appServiceImpl, globalCMCSServiceImpl, argoWorkflowExecutorImpl, k8sUtil, systemWorkflowExecutorImpl)
	if err != nil {
		return nil, err
	}
	...
	imageTaggingRepositoryImpl := repository10.NewImageTaggingRepositoryImpl(db)
	...
	ciServiceImpl := pipeline.NewCiServiceImpl(sugaredLogger, ciPipelineMaterialRepositoryImpl, ciWorkflowRepositoryImpl, ciConfig, eventRESTClientImpl, eventSimpleFactoryImpl, mergeUtil, ciPipelineRepositoryImpl, prePostCiScriptHistoryServiceImpl, pipelineStageServiceImpl, userServiceImpl, ciTemplateServiceImpl, appCrudOperationServiceImpl, environmentRepositoryImpl, appRepositoryImpl, commonWorkflowServiceImpl)
