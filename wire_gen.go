...
func InitializeApp() (*App, error) {
	...
	externalLinkMonitoringToolRepositoryImpl := externalLinks.NewExternalLinkMonitoringToolRepositoryImpl(db)
	externalLinkClusterMappingRepositoryImpl := externalLinks.NewExternalLinkClusterMappingRepositoryImpl(db)
	externalLinkRepositoryImpl := externalLinks.NewExternalLinkRepositoryImpl(db)
	externalLinkServiceImpl := externalLinks.NewExternalLinkServiceImpl(sugaredLogger, externalLinkMonitoringToolRepositoryImpl, externalLinkClusterMappingRepositoryImpl, externalLinkRepositoryImpl, userAuthServiceImpl)
	externalLinkRestHandlerImpl := externalLinks2.NewExternalLinkRestHandlerImpl(sugaredLogger, externalLinkServiceImpl, userServiceImpl, enforcerImpl, validate, userAuthServiceImpl, deleteServiceExtendedImpl)
	externalLinkRouterImpl := externalLinks2.NewExternalLinkRouterImpl(externalLinkRestHandlerImpl)
