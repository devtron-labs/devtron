...
func InitializeApp() (*App, error) {
	...
	repositoryServiceImpl := ArgoUtil.NewRepositoryService(argoSession)
	chartTemplateServiceImpl := util.NewChartTemplateServiceImpl(sugaredLogger, chartWorkingDir, httpClient, gitFactory, globalEnvVariables, gitOpsConfigRepositoryImpl, userRepositoryImpl, repositoryServiceClientImpl, repositoryServiceImpl)
