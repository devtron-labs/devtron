...
import (
	...
	config2 "github.com/devtron-labs/devtron/pkg/config"
...
func InitializeApp() (*App, error) {
	...
	deploymentConfigurationServiceImpl, err := config2.NewDeploymentConfigurationServiceImpl(sugaredLogger, configMapServiceImpl)
	if err != nil {
		return nil, err
	}
