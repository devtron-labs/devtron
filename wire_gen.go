...
func InitializeApp() (*App, error) {
	...
	artifactPromotionApprovalRequestRepoImpl := repository20.NewRequestRepositoryImpl(db)
	...
	artifactPromotionApprovalServiceImpl := artifactPromotion.NewApprovalRequestServiceImpl(artifactPromotionApprovalRequestRepoImpl, sugaredLogger, ciPipelineRepositoryImpl, pipelineRepositoryImpl, userServiceImpl, ciArtifactRepositoryImpl, appWorkflowRepositoryImpl, cdWorkflowRepositoryImpl, resourceFilterEvaluatorImpl, imageTaggingServiceImpl, artifactPromotionDataReadServiceImpl, requestApprovalUserDataRepositoryImpl, workflowDagExecutorImpl, promotionPolicyServiceImpl, pipelineStageServiceImpl, environmentServiceImpl, filterEvaluationAuditServiceImpl)
