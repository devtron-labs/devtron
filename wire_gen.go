...
func InitializeApp() (*App, error) {
	...
	centralEventProcessor, err := eventProcessor.NewCentralEventProcessor(sugaredLogger, workflowEventProcessorImpl, ciPipelineEventProcessorImpl, deployedApplicationEventProcessorImpl)
	if err != nil {
		return nil, err
	}
