...
There may be some other pods also in crashloop as they are not able to connect to database. To resolve this issue, you can either [update devtron to latest version](https://docs.devtron.ai/v/v0.5/getting-started/upgrade) or run the following commands to fix instantly on the same version you are using: 
```bash
...
`Debug:`
1. Make sure to [annotate and label](https://docs.devtron.ai/v/v0.5/getting-started/upgrade/devtron-upgrade-0.3.x-0.4.x#3.-annotate-and-label-all-the-devtron-resources) all the Devtron resources.
