    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li>{envId}</li>
                <li>{namespace}</li>
                <li>{podName}: If used, the link will only be visible at the pod level on the <a href="https://docs.devtron.ai/v/v0.5/usage/applications/app-details">App details</a> page. </li>
                <li>{containerName}: If used, the link will only be visible at the container level on the <a href="https://docs.devtron.ai/v/v0.5/usage/applications/app-details">App details</a> page. </li>
            </ul>
...
The users (admin and others) can access the configured external link from the [App details](https://docs.devtron.ai/v/v0.5/usage/applications/app-details) page.
