...
import (
	...
	repository6 "github.com/devtron-labs/devtron/internal/sql/repository"
	...
	repository10 "github.com/devtron-labs/devtron/pkg/appStore/chartGroup/repository"
	...
	repository7 "github.com/devtron-labs/devtron/pkg/appStore/installedApp/repository"
	...
	config4 "github.com/devtron-labs/devtron/pkg/overview/config"
	"github.com/devtron-labs/devtron/pkg/pipeline"
	"github.com/devtron-labs/devtron/pkg/policyGovernance/security/scanTool"
	repository12 "github.com/devtron-labs/devtron/pkg/policyGovernance/security/scanTool/repository"
...
func InitializeApp() (*App, error) {
	...
	teamRepositoryImpl := repository3.NewTeamRepositoryImpl(db)
	...
	clusterRepositoryImpl := repository4.NewClusterRepositoryImpl(db, sugaredLogger, environmentVariables)
	...
	environmentRepositoryImpl := repository5.NewEnvironmentRepositoryImpl(db, sugaredLogger, appStatusRepositoryImpl)
	attributesRepositoryImpl := repository6.NewAttributesRepositoryImpl(db)
	...
	installedAppRepositoryImpl := repository7.NewInstalledAppRepositoryImpl(sugaredLogger, db)
	...
	installedAppVersionHistoryRepositoryImpl := repository7.NewInstalledAppVersionHistoryRepositoryImpl(sugaredLogger, db)
	...
	envConfigOverrideReadServiceImpl := read5.NewEnvConfigOverrideReadServiceImpl(sugaredLogger, environmentRepositoryImpl, envConfigOverrideRepositoryImpl)
	...
	dockerArtifactStoreRepositoryImpl := repository8.NewDockerArtifactStoreRepositoryImpl(db, environmentVariables)
	...
	genericNoteRepositoryImpl := repository9.NewGenericNoteRepositoryImpl(db, transactionUtilImpl)
	genericNoteHistoryRepositoryImpl := repository9.NewGenericNoteHistoryRepositoryImpl(db, transactionUtilImpl)
	...
	gitOpsConfigRepositoryImpl := repository6.NewGitOpsConfigRepositoryImpl(sugaredLogger, db, environmentVariables)
	...
	chartGroupDeploymentRepositoryImpl := repository10.NewChartGroupDeploymentRepositoryImpl(db, sugaredLogger)
	...
	fluxApplicationServiceImpl := fluxApplication.NewFluxApplicationServiceImpl(sugaredLogger, helmAppReadServiceImpl, clusterServiceImpl, helmAppClientImpl, pumpImpl, pipelineRepositoryImpl, installedAppRepositoryImpl)
	...
	userAttributesRepositoryImpl := repository6.NewUserAttributesRepositoryImpl(db)
	...
	scanToolMetadataRepositoryImpl := repository12.NewScanToolMetadataRepositoryImpl(db, sugaredLogger)
	...
	k8sCapacityRestHandlerImpl := capacity2.NewK8sCapacityRestHandlerImpl(sugaredLogger, k8sCapacityServiceImpl, userServiceImpl, enforcerImpl, clusterServiceImpl, environmentServiceImpl, clusterRbacServiceImpl, clusterReadServiceImpl, validate, clusterCacheServiceImpl)
	...
	terminalAccessRepositoryImpl := repository6.NewTerminalAccessRepositoryImpl(db, sugaredLogger)
	...
	argoApplicationRestHandlerImpl := argoApplication2.NewArgoApplicationRestHandlerImpl(argoApplicationServiceImpl, argoApplicationReadServiceImpl, sugaredLogger, enforcerImpl, enforcerUtilGitOpsImpl)
	...
	userResourceServiceImpl := userResource.NewUserResourceServiceImpl(sugaredLogger, teamServiceImpl, environmentServiceImpl, clusterServiceImpl, k8sApplicationServiceImpl, enforcerUtilImpl, commonEnforcementUtilImpl, enforcerImpl, appCrudOperationServiceImpl, argoApplicationServiceImpl, fluxApplicationServiceImpl)
	...
	clusterOverviewConfig, err := config4.GetClusterOverviewConfig()
	if err != nil {
		return nil, err
	}
	clusterOverviewServiceImpl := overview.NewClusterOverviewServiceImpl(sugaredLogger, clusterServiceImpl, k8sCapacityServiceImpl, clusterCacheServiceImpl, k8sCommonServiceImpl, enforcerImpl, clusterOverviewConfig)
