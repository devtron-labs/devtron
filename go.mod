...
require (
	...
	github.com/devtron-labs/common-lib v0.0.16-0.20240404105222-a97eb62df3b3
	github.com/devtron-labs/common-lib-private v0.0.14-0.20240301113626-305856902377
