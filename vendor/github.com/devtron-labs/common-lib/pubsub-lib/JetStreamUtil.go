...
const (
	...
	DEVTRON_CHART_INSTALL_TOPIC         string = "DEVTRON-CHART-INSTALL-STATUS-TOPIC"
	DEVTRON_CHART_INSTALL_GROUP         string = "DEVTRON-CHART-INSTALL-STATUS-GROUP"
	DEVTRON_CHART_INSTALL_DURABLE       string = "DEVTRON-CHART-INSTALL-STATUS-DURABLE"
)
