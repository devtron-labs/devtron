...
// NOTE : notnull added manually, as auto-generation does not add notnull.
...
type CreateApiTokenRequest struct {
	// Name of api-token
	Name *string `json:"name,omitempty,notnull"`
	// Description of api-token
	Description *string `json:"description,omitempty,notnull"`
