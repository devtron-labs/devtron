...
import (
	...
	"github.com/devtron-labs/devtron/api/enterprise/globalTag"
...
func NewMuxRouter(logger *zap.SugaredLogger, HelmRouter PipelineTriggerRouter, PipelineConfigRouter PipelineConfigRouter,
	...
	userTerminalAccessRouter terminal2.UserTerminalAccessRouter, ciStatusUpdateCron cron.CiStatusUpdateCron, globalTagRouter globalTag.GlobalTagRouter) *MuxRouter {
	r := &MuxRouter{
