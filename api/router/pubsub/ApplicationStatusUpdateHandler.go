...
type ApplicationStatusUpdateHandlerImpl struct {
	...
	installedAppService appStoreDeployment.InstalledAppService
}
...
func NewApplicationStatusUpdateHandlerImpl(logger *zap.SugaredLogger, pubsubClient *pubsub.PubSubClient, appService app.AppService,
	workflowDagExecutor pipeline.WorkflowDagExecutor, installedAppService appStoreDeployment.InstalledAppService) *ApplicationStatusUpdateHandlerImpl {
