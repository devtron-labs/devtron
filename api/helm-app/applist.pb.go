...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x32, 0xd9, 0x06, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61,
	...
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x09, 0x48, 0x69, 0x62, 0x65, 0x72,
...
var file_grpc_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_grpc_applist_proto_goTypes = []interface{}{
	...
	nil,                              // 34: ResourceNetworkingInfo.LabelsEntry
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	35, // 3: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	0,  // 4: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	7,  // 5: AppDetail.releaseStatus:type_name -> ReleaseStatus
	35, // 6: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	...
	34, // 15: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	...
	35, // 21: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	...
	25, // 43: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	2,  // 44: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 45: ApplicationService.GetAppDetail:output_type -> AppDetail
	18, // 46: ApplicationService.Hibernate:output_type -> HibernateResponse
	18, // 47: ApplicationService.UnHibernate:output_type -> HibernateResponse
	20, // 48: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	21, // 49: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	23, // 50: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	24, // 51: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	27, // 52: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	29, // 53: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	32, // 54: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	27, // 55: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	33, // 56: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
