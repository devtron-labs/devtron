...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x32, 0xdc, 0x07, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c,
	...
	0x70, 0x70, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x09, 0x48, 0x69,
...
var file_grpc_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_grpc_applist_proto_goTypes = []interface{}{
	...
	nil,                              // 36: ResourceNetworkingInfo.LabelsEntry
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	37, // 3: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	0,  // 4: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	7,  // 5: AppDetail.releaseStatus:type_name -> ReleaseStatus
	37, // 6: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	...
	36, // 15: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	...
	37, // 21: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	...
	31, // 46: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	2,  // 47: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 48: ApplicationService.GetAppDetail:output_type -> AppDetail
	18, // 49: ApplicationService.Hibernate:output_type -> HibernateResponse
	18, // 50: ApplicationService.UnHibernate:output_type -> HibernateResponse
	20, // 51: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	21, // 52: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	23, // 53: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	24, // 54: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	27, // 55: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	29, // 56: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	32, // 57: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	27, // 58: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	33, // 59: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	33, // 60: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	35, // 61: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
