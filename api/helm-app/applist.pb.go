...
var file_applist_proto_rawDesc = []byte{
	...
	0x77, 0x32, 0x80, 0x01, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	...
	0x69, 0x6c, 0x22, 0x00, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_applist_proto_goTypes = []interface{}{
	...
	nil,                            // 15: ResourceNetworkingInfo.LabelsEntry
...
var file_applist_proto_depIdxs = []int32{
	...
	16, // 3: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	0,  // 4: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	7,  // 5: AppDetail.releaseStatus:type_name -> ReleaseStatus
	16, // 6: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	...
	15, // 14: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	1,  // 15: ApplicationService.ListApplications:input_type -> AppListRequest
	5,  // 16: ApplicationService.GetAppDetail:input_type -> AppDetailRequest
	2,  // 17: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 18: ApplicationService.GetAppDetail:output_type -> AppDetail
