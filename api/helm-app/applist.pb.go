...
var file_api_helm_app_applist_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0xea, 0x02, 0x0a, 0x15, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x6c,
	...
	0x68, 0x61, 0x72, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28,
	...
	0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x32, 0xf6, 0x09, 0x0a, 0x12, 0x41, 0x70,
...
var file_api_helm_app_applist_proto_depIdxs = []int32{
	...
	48, // 41: ResourceIdentifier.labels:type_name -> ResourceIdentifier.LabelsEntry
	...
	2,  // 63: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 64: ApplicationService.GetAppDetail:output_type -> AppDetail
	7,  // 65: ApplicationService.GetAppStatus:output_type -> AppStatus
	21, // 66: ApplicationService.Hibernate:output_type -> HibernateResponse
	21, // 67: ApplicationService.UnHibernate:output_type -> HibernateResponse
	23, // 68: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	24, // 69: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	26, // 70: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	27, // 71: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	30, // 72: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	32, // 73: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	35, // 74: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	30, // 75: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	36, // 76: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	36, // 77: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	38, // 78: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	40, // 79: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
	46, // 80: ApplicationService.GetNotes:output_type -> ChartNotesResponse
	30, // 81: ApplicationService.UpgradeReleaseWithCustomChart:output_type -> UpgradeReleaseResponse
