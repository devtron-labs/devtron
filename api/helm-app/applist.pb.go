...
func (x *ResourceFilter) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
type ResourceTreeFilter struct {
	...
	ResourceFilters []*ResourceFilter `protobuf:"bytes,1,rep,name=resourceFilters,proto3" json:"resourceFilters,omitempty"`
}
...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x6c, 0x73, 0x22, 0x63, 0x0a, 0x0d, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x53, 0x74, 0x61,
	...
	0x61, 0x52, 0x0b, 0x70, 0x6f, 0x64, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xe1,
	...
	0x41, 0x74, 0x22, 0x34, 0x0a, 0x08, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x12,
	...
	0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0x91, 0x01, 0x0a, 0x0b, 0x50, 0x6f, 0x64, 0x4d, 0x65, 0x74,
	...
	0x28, 0x08, 0x52, 0x05, 0x69, 0x73, 0x4e, 0x65, 0x77, 0x22, 0x87, 0x01, 0x0a, 0x10, 0x48, 0x69,
	...
	0x65, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x64, 0x41, 0x74, 0x22, 0x62, 0x0a, 0x18, 0x48, 0x65, 0x6c,
	...
	0x65, 0x22, 0x79, 0x0a, 0x15, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x52, 0x65, 0x6c, 0x65,
	...
	0x52, 0x0a, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x59, 0x61, 0x6d, 0x6c, 0x22, 0x32, 0x0a, 0x16,
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xf7, 0x01, 0x0a, 0x15, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c,
	...
	0x63, 0x68, 0x61, 0x72, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x22,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x4b, 0x69, 0x6e, 0x64, 0x22, 0x98, 0x01, 0x0a, 0x0e, 0x52, 0x65,
	...
	0x03, 0x67, 0x76, 0x6b, 0x12, 0x33, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x46,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x4f, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x54, 0x72, 0x65, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x39, 0x0a, 0x0f, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20,
	...
	0x6c, 0x74, 0x65, 0x72, 0x73, 0x32, 0xb6, 0x08, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63,
	...
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x09, 0x48, 0x69, 0x62, 0x65,
	...
	0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x33,
...
var file_grpc_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_grpc_applist_proto_goTypes = []interface{}{
	...
	(*InfoItem)(nil),                  // 11: InfoItem
	(*HealthStatus)(nil),              // 12: HealthStatus
	(*ResourceNetworkingInfo)(nil),    // 13: ResourceNetworkingInfo
	(*ResourceRef)(nil),               // 14: ResourceRef
	(*PodMetadata)(nil),               // 15: PodMetadata
	(*HibernateRequest)(nil),          // 16: HibernateRequest
	(*ObjectIdentifier)(nil),          // 17: ObjectIdentifier
	(*HibernateStatus)(nil),           // 18: HibernateStatus
	(*HibernateResponse)(nil),         // 19: HibernateResponse
	(*HelmAppDeploymentDetail)(nil),   // 20: HelmAppDeploymentDetail
	(*HelmAppDeploymentHistory)(nil),  // 21: HelmAppDeploymentHistory
	(*ReleaseInfo)(nil),               // 22: ReleaseInfo
	(*ObjectRequest)(nil),             // 23: ObjectRequest
	(*DesiredManifestResponse)(nil),   // 24: DesiredManifestResponse
	(*UninstallReleaseResponse)(nil),  // 25: UninstallReleaseResponse
	(*ReleaseIdentifier)(nil),         // 26: ReleaseIdentifier
	(*UpgradeReleaseRequest)(nil),     // 27: UpgradeReleaseRequest
	(*UpgradeReleaseResponse)(nil),    // 28: UpgradeReleaseResponse
	(*DeploymentDetailRequest)(nil),   // 29: DeploymentDetailRequest
	(*DeploymentDetailResponse)(nil),  // 30: DeploymentDetailResponse
	(*ChartRepository)(nil),           // 31: ChartRepository
	(*InstallReleaseRequest)(nil),     // 32: InstallReleaseRequest
	(*InstallReleaseResponse)(nil),    // 33: InstallReleaseResponse
	(*BooleanResponse)(nil),           // 34: BooleanResponse
	(*RollbackReleaseRequest)(nil),    // 35: RollbackReleaseRequest
	(*TemplateChartResponse)(nil),     // 36: TemplateChartResponse
	(*HelmInstallCustomRequest)(nil),  // 37: HelmInstallCustomRequest
	(*HelmInstallCustomResponse)(nil), // 38: HelmInstallCustomResponse
	(*ChartContent)(nil),              // 39: ChartContent
	(*Gvk)(nil),                       // 40: Gvk
	(*ResourceFilter)(nil),            // 41: ResourceFilter
	(*ResourceTreeFilter)(nil),        // 42: ResourceTreeFilter
	nil,                               // 43: ResourceNetworkingInfo.LabelsEntry
	nil,                               // 44: ResourceFilter.LabelsEntry
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	45, // 3: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	0,  // 4: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	42, // 5: AppDetailRequest.resourceTreeFilter:type_name -> ResourceTreeFilter
	7,  // 6: AppDetail.releaseStatus:type_name -> ReleaseStatus
	45, // 7: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	8,  // 8: AppDetail.chartMetadata:type_name -> ChartMetadata
	9,  // 9: AppDetail.resourceTreeResponse:type_name -> ResourceTreeResponse
	4,  // 10: AppDetail.environmentDetails:type_name -> EnvironmentDetails
	10, // 11: ResourceTreeResponse.nodes:type_name -> ResourceNode
	15, // 12: ResourceTreeResponse.podMetadata:type_name -> PodMetadata
	14, // 13: ResourceNode.parentRefs:type_name -> ResourceRef
	13, // 14: ResourceNode.networkingInfo:type_name -> ResourceNetworkingInfo
	12, // 15: ResourceNode.health:type_name -> HealthStatus
	11, // 16: ResourceNode.info:type_name -> InfoItem
	43, // 17: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	0,  // 18: HibernateRequest.clusterConfig:type_name -> ClusterConfig
	17, // 19: HibernateRequest.objectIdentifier:type_name -> ObjectIdentifier
	17, // 20: HibernateStatus.targetObject:type_name -> ObjectIdentifier
	18, // 21: HibernateResponse.status:type_name -> HibernateStatus
	8,  // 22: HelmAppDeploymentDetail.chartMetadata:type_name -> ChartMetadata
	45, // 23: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	20, // 24: HelmAppDeploymentHistory.deploymentHistory:type_name -> HelmAppDeploymentDetail
	3,  // 25: ReleaseInfo.deployedAppDetail:type_name -> DeployedAppDetail
	0,  // 26: ObjectRequest.clusterConfig:type_name -> ClusterConfig
	17, // 27: ObjectRequest.objectIdentifier:type_name -> ObjectIdentifier
	0,  // 28: ReleaseIdentifier.clusterConfig:type_name -> ClusterConfig
	26, // 29: UpgradeReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	26, // 30: DeploymentDetailRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	26, // 31: InstallReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	31, // 32: InstallReleaseRequest.chartRepository:type_name -> ChartRepository
	26, // 33: RollbackReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	39, // 34: HelmInstallCustomRequest.chartContent:type_name -> ChartContent
	26, // 35: HelmInstallCustomRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	40, // 36: ResourceFilter.gvk:type_name -> Gvk
	44, // 37: ResourceFilter.labels:type_name -> ResourceFilter.LabelsEntry
	41, // 38: ResourceTreeFilter.resourceFilters:type_name -> ResourceFilter
	1,  // 39: ApplicationService.ListApplications:input_type -> AppListRequest
	5,  // 40: ApplicationService.GetAppDetail:input_type -> AppDetailRequest
	16, // 41: ApplicationService.Hibernate:input_type -> HibernateRequest
	16, // 42: ApplicationService.UnHibernate:input_type -> HibernateRequest
	5,  // 43: ApplicationService.GetDeploymentHistory:input_type -> AppDetailRequest
	5,  // 44: ApplicationService.GetValuesYaml:input_type -> AppDetailRequest
	23, // 45: ApplicationService.GetDesiredManifest:input_type -> ObjectRequest
	26, // 46: ApplicationService.UninstallRelease:input_type -> ReleaseIdentifier
	27, // 47: ApplicationService.UpgradeRelease:input_type -> UpgradeReleaseRequest
	29, // 48: ApplicationService.GetDeploymentDetail:input_type -> DeploymentDetailRequest
	32, // 49: ApplicationService.InstallRelease:input_type -> InstallReleaseRequest
	32, // 50: ApplicationService.UpgradeReleaseWithChartInfo:input_type -> InstallReleaseRequest
	26, // 51: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	35, // 52: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	32, // 53: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	37, // 54: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	2,  // 55: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 56: ApplicationService.GetAppDetail:output_type -> AppDetail
	19, // 57: ApplicationService.Hibernate:output_type -> HibernateResponse
	19, // 58: ApplicationService.UnHibernate:output_type -> HibernateResponse
	21, // 59: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	22, // 60: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	24, // 61: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	25, // 62: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	28, // 63: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	30, // 64: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	33, // 65: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	28, // 66: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	34, // 67: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	34, // 68: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	36, // 69: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	38, // 70: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
