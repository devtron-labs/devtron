...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x32, 0xb6,
	0x08, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65,
...
var file_grpc_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_grpc_applist_proto_goTypes = []interface{}{
	...
	(*ResourceIdentifier)(nil),        // 42: ResourceIdentifier
	(*ResourceTreeFilter)(nil),        // 43: ResourceTreeFilter
	nil,                               // 44: ResourceNetworkingInfo.LabelsEntry
	nil,                               // 45: ResourceIdentifier.LabelsEntry
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	46, // 3: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	0,  // 4: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	43, // 5: AppDetailRequest.resourceTreeFilter:type_name -> ResourceTreeFilter
	7,  // 6: AppDetail.releaseStatus:type_name -> ReleaseStatus
	46, // 7: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	...
	44, // 17: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	...
	46, // 23: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	...
	42, // 37: ResourceFilter.resourceIdentifier:type_name -> ResourceIdentifier
	45, // 38: ResourceIdentifier.labels:type_name -> ResourceIdentifier.LabelsEntry
	42, // 39: ResourceTreeFilter.globalFilter:type_name -> ResourceIdentifier
	41, // 40: ResourceTreeFilter.resourceFilters:type_name -> ResourceFilter
	...
	16, // 43: ApplicationService.Hibernate:input_type -> HibernateRequest
	16, // 44: ApplicationService.UnHibernate:input_type -> HibernateRequest
	5,  // 45: ApplicationService.GetDeploymentHistory:input_type -> AppDetailRequest
	5,  // 46: ApplicationService.GetValuesYaml:input_type -> AppDetailRequest
	23, // 47: ApplicationService.GetDesiredManifest:input_type -> ObjectRequest
	26, // 48: ApplicationService.UninstallRelease:input_type -> ReleaseIdentifier
	27, // 49: ApplicationService.UpgradeRelease:input_type -> UpgradeReleaseRequest
	29, // 50: ApplicationService.GetDeploymentDetail:input_type -> DeploymentDetailRequest
	32, // 51: ApplicationService.InstallRelease:input_type -> InstallReleaseRequest
	32, // 52: ApplicationService.UpgradeReleaseWithChartInfo:input_type -> InstallReleaseRequest
	26, // 53: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	35, // 54: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	32, // 55: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	37, // 56: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	2,  // 57: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 58: ApplicationService.GetAppDetail:output_type -> AppDetail
	19, // 59: ApplicationService.Hibernate:output_type -> HibernateResponse
	19, // 60: ApplicationService.UnHibernate:output_type -> HibernateResponse
	21, // 61: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	22, // 62: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	24, // 63: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	25, // 64: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	28, // 65: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	30, // 66: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	33, // 67: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	28, // 68: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	34, // 69: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	34, // 70: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	36, // 71: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	38, // 72: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
