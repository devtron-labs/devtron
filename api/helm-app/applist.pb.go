...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x64, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xc3, 0x03, 0x0a, 0x0c, 0x52, 0x65,
	...
	0x2e, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75,
	0x69, 0x64, 0x22, 0x91, 0x01, 0x0a, 0x0b, 0x50, 0x6f, 0x64, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x28, 0x0c, 0x52, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x32, 0xb6, 0x08, 0x0a, 0x12,
	...
	0x1a, 0x0a, 0x2e, 0x41, 0x70, 0x70, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x00, 0x12, 0x34,
...
var file_grpc_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_grpc_applist_proto_goTypes = []interface{}{
	...
	nil,                               // 40: ResourceNetworkingInfo.LabelsEntry
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	41, // 3: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	0,  // 4: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	7,  // 5: AppDetail.releaseStatus:type_name -> ReleaseStatus
	41, // 6: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	...
	15, // 11: ResourceTreeResponse.podMetadata:type_name -> PodMetadata
	14, // 12: ResourceNode.parentRefs:type_name -> ResourceRef
	13, // 13: ResourceNode.networkingInfo:type_name -> ResourceNetworkingInfo
	12, // 14: ResourceNode.health:type_name -> HealthStatus
	11, // 15: ResourceNode.info:type_name -> InfoItem
	40, // 16: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	0,  // 17: HibernateRequest.clusterConfig:type_name -> ClusterConfig
	17, // 18: HibernateRequest.objectIdentifier:type_name -> ObjectIdentifier
	17, // 19: HibernateStatus.targetObject:type_name -> ObjectIdentifier
	18, // 20: HibernateResponse.status:type_name -> HibernateStatus
	8,  // 21: HelmAppDeploymentDetail.chartMetadata:type_name -> ChartMetadata
	41, // 22: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	20, // 23: HelmAppDeploymentHistory.deploymentHistory:type_name -> HelmAppDeploymentDetail
	3,  // 24: ReleaseInfo.deployedAppDetail:type_name -> DeployedAppDetail
	0,  // 25: ObjectRequest.clusterConfig:type_name -> ClusterConfig
	17, // 26: ObjectRequest.objectIdentifier:type_name -> ObjectIdentifier
	0,  // 27: ReleaseIdentifier.clusterConfig:type_name -> ClusterConfig
	26, // 28: UpgradeReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	26, // 29: DeploymentDetailRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	26, // 30: InstallReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	31, // 31: InstallReleaseRequest.chartRepository:type_name -> ChartRepository
	26, // 32: RollbackReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	39, // 33: HelmInstallCustomRequest.chartContent:type_name -> ChartContent
	26, // 34: HelmInstallCustomRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	1,  // 35: ApplicationService.ListApplications:input_type -> AppListRequest
	5,  // 36: ApplicationService.GetAppDetail:input_type -> AppDetailRequest
	16, // 37: ApplicationService.Hibernate:input_type -> HibernateRequest
	16, // 38: ApplicationService.UnHibernate:input_type -> HibernateRequest
	5,  // 39: ApplicationService.GetDeploymentHistory:input_type -> AppDetailRequest
	5,  // 40: ApplicationService.GetValuesYaml:input_type -> AppDetailRequest
	23, // 41: ApplicationService.GetDesiredManifest:input_type -> ObjectRequest
	26, // 42: ApplicationService.UninstallRelease:input_type -> ReleaseIdentifier
	27, // 43: ApplicationService.UpgradeRelease:input_type -> UpgradeReleaseRequest
	29, // 44: ApplicationService.GetDeploymentDetail:input_type -> DeploymentDetailRequest
	32, // 45: ApplicationService.InstallRelease:input_type -> InstallReleaseRequest
	32, // 46: ApplicationService.UpgradeReleaseWithChartInfo:input_type -> InstallReleaseRequest
	26, // 47: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	35, // 48: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	32, // 49: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	37, // 50: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	2,  // 51: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 52: ApplicationService.GetAppDetail:output_type -> AppDetail
	19, // 53: ApplicationService.Hibernate:output_type -> HibernateResponse
	19, // 54: ApplicationService.UnHibernate:output_type -> HibernateResponse
	21, // 55: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	22, // 56: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	24, // 57: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	25, // 58: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	28, // 59: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	30, // 60: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	33, // 61: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	28, // 62: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	34, // 63: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	34, // 64: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	36, // 65: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	38, // 66: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
