...
func (handler *PipelineConfigRestHandlerImpl) GetSourceCiDownStreamFilters(w http.ResponseWriter, r *http.Request) {
	...
	// RBAC enforcer Ends
	// TODO Komal: remove this unnecessary declaration
	var resp *linkedCIView.LinkedCIInfoFilters
	resp, err = handler.ciCdPipelineOrchestrator.GetSourceCiDownStreamFilters(ciPipelineId)
	if err != nil {
