...
type ChartGroupRestHandlerImpl struct {
	ChartGroupService appStoreDeployment.ChartGroupService
...
func NewChartGroupRestHandlerImpl(ChartGroupService appStoreDeployment.ChartGroupService,
...
func (impl *ChartGroupRestHandlerImpl) CreateChartGroup(w http.ResponseWriter, r *http.Request) {
	...
	var request appStoreDeployment.ChartGroupBean
