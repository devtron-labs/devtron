...
COPY --from=build-env  /go/src/github.com/devtron-labs/devtron/scripts/argo-assets/APPLICATION_TEMPLATE_PRIVATE_CHART.JSON scripts/argo-assets/APPLICATION_TEMPLATE_PRIVATE_CHART.JSON
