...
func (impl UserAuthRepositoryImpl) CreateDefaultPolicies(team string, entityName string, env string, tx *pg.Tx) (bool, error) {
	...
	policies, err := impl.generateDefaultPolicies(team, entityName, env)
	if err != nil {
		return false, err
	}
...
func (impl UserAuthRepositoryImpl) generateDefaultPolicies(team string, entityName string, env string) ([]bean.PolicyRequest, error) {
