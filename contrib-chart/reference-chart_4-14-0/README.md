...
# Rollout Deployment Chart - v4.14
...
### Env Variables from specific secret key
```yaml
EnvVariablesFromSecretKey:
  - name: ENV_NAME
    secretName: testSecret
    secretKey: testKey # a key from the secret
```
Defines environment variables from a specific secret key
