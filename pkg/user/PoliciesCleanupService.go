...
type CleanUpPoliciesServiceImpl struct {
	...
	cleanUpPoliciesRepository repository2.PoliciesCleanUpRepository
}

func NewCleanUpPoliciesServiceImpl(userAuthRepository repository2.UserAuthRepository,
	logger *zap.SugaredLogger, userRepository repository2.UserRepository,
	roleGroupRepository repository2.RoleGroupRepository,
	cleanUpPoliciesRepository repository2.PoliciesCleanUpRepository) *CleanUpPoliciesServiceImpl {
