...
type ClusterService interface {
	...
	DeleteFromDb(ctx context.Context, bean *ClusterBean, userId int32) error
...
func (impl ClusterServiceImpl) DeleteFromDb(ctx context.Context, bean *ClusterBean, userId int32) error {
