...
// FindByIdsOrderByCluster provides a mock function with given fields: ids
func (_m *EnvironmentRepository) FindByIdsOrderByCluster(ids []int) ([]*repository.Environment, error) {
	ret := _m.Called(ids)
