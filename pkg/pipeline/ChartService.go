...
type ChartService interface {
	...
	MergeDefaultTemplateWithSavedTemplateData(RequestChartRefId int,templateRequest *TemplateRequest)(*TemplateRequest, error)
}
...
func (impl ChartServiceImpl) MergeDefaultTemplateWithSavedTemplateData(RequestChartRefId int,templateRequest *TemplateRequest)(*TemplateRequest, error){
