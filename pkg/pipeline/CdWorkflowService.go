...
//	SubmitWorkflow(workflowRequest *CommonWorkflowRequest, pipeline *pipelineConfig.Pipeline, env *repository.Environment) error
...
//	///common but different json
//	//AppId int `json:"appId"` //common
//	///EnvironmentId              int                                 `json:"envId"`
//	//WorkflowId int `json:"workflowId"` //common
//	//WorkflowRunnerId           int                                 `json:"workflowRunnerId"`
//	//CdPipelineId               int                                 `json:"cdPipelineId"`
//	//TriggeredBy int32 `json:"triggeredBy"` //common
//	//StageYaml                  string                              `json:"stageYaml"`
//	//ArtifactLocation           string                              `json:"artifactLocation"`
//	//CiArtifactBucket string `json:"ciArtifactBucket"` //json is same but different variable name
//	//CiArtifactFileName string `json:"ciArtifactFileName"` //json is same but different variable name
//	//ArtifactRegion string `json:"ciArtifactRegion"` //json is same but different variable name
//	//CiProjectDetails           []CiProjectDetails                  `json:"ciProjectDetails"`//common
//	//CiArtifactDTO              CiArtifactDTO                       `json:"ciArtifactDTO"`
//	//Namespace                  string                              `json:"namespace"` //common
//	//WorkflowNamePrefix         string                              `json:"workflowNamePrefix"` //common
//	//CdImage                    string                              `json:"cdImage"`
//	//ActiveDeadlineSeconds      int64                               `json:"activeDeadlineSeconds"` //common
//	//StageType                  string                              `json:"stageType"`
//	//DockerUsername             string                              `json:"dockerUsername"` //common
//	//DockerPassword             string                              `json:"dockerPassword"` //common
//	//AwsRegion                  string                              `json:"awsRegion"` //common
//	//SecretKey                  string                              `json:"secretKey"` //common
//	//AccessKey                  string                              `json:"accessKey"` //common
//	//DockerConnection           string                              `json:"dockerConnection"` //common
//	//DockerCert                 string                              `json:"dockerCert"` //common
//	//CdCacheLocation            string                              `json:"cdCacheLocation"`
//	//CdCacheRegion              string                              `json:"cdCacheRegion"`
//	//DockerRegistryType         string                              `json:"dockerRegistryType"` //common
//	//DockerRegistryURL          string                              `json:"dockerRegistryURL"` //common
//	//OrchestratorHost           string                              `json:"orchestratorHost"` //common
//	//OrchestratorToken          string                              `json:"orchestratorToken"` //common
//	//IsExtRun bool `json:"isExtRun"` //common
//	//ExtraEnvironmentVariables  map[string]string                   `json:"extraEnvironmentVariables"` //common
//	//BlobStorageConfigured      bool                                `json:"blobStorageConfigured"` //common
//	//BlobStorageS3Config        *blob_storage.BlobStorageS3Config   `json:"blobStorageS3Config"` //common
//	//CloudProvider              blob_storage.BlobStorageType        `json:"cloudProvider"` //common
//	//AzureBlobConfig            *blob_storage.AzureBlobConfig       `json:"azureBlobConfig"` //common
//	//GcpBlobConfig              *blob_storage.GcpBlobConfig         `json:"gcpBlobConfig"` //common
//	//BlobStorageLogsKey         string                              `json:"blobStorageLogsKey"` //common
//	//InAppLoggingEnabled        bool                                `json:"inAppLoggingEnabled"` //common
//	//WorkflowPrefixForLog       string                              `json:"workflowPrefixForLog"`
//	//CiDefaultAddressPoolBaseCidr string                              `json:"defaultAddressPoolBaseCidr"` //common
//	//CiDefaultAddressPoolSize     int                                 `json:"defaultAddressPoolSize"` //common
...
//	//RefPlugins         []*bean3.RefPluginObject `json:"refPlugins"` //common
//}
//
//const PRE = "PRE"
//const POST = "POST"
//
//func NewCdWorkflowServiceImpl(Logger *zap.SugaredLogger, envRepository repository.EnvironmentRepository, cdConfig *CiCdConfig,
...
//}
//
//func (impl *CdWorkflowServiceImpl) SubmitWorkflow(workflowRequest *CommonWorkflowRequest, pipeline *pipelineConfig.Pipeline, env *repository.Environment) error {
//
...
//	ciCdTriggerEvent.CdRequest.BlobStorageLogsKey = fmt.Sprintf("%s/%s", impl.cdConfig.CdDefaultBuildLogsKeyPrefix, workflowRequest.WorkflowPrefixForLog)
...
//
//	workflowTemplate.ServiceAccountName = impl.cdConfig.CdWorkflowServiceAccount
//	workflowTemplate.NodeSelector = map[string]string{impl.cdConfig.CdTaintKey: impl.cdConfig.CdTaintValue}
//	workflowTemplate.Tolerations = []v12.Toleration{{Key: impl.cdConfig.CdTaintKey, Value: impl.cdConfig.CdTaintValue, Operator: v12.TolerationOpEqual, Effect: v12.TaintEffectNoSchedule}}
...
//	}
//
//	limitCpu := impl.cdConfig.CdLimitCpu
//	limitMem := impl.cdConfig.CdLimitMem
//	reqCpu := impl.cdConfig.CdReqCpu
//	reqMem := impl.cdConfig.CdReqMem
//
...
//}
//
//func (impl *CdWorkflowServiceImpl) updateBlobStorageConfig(workflowRequest *CommonWorkflowRequest, workflowTemplate *bean3.WorkflowTemplate, storageConfigured bool, blobStorageKey string) {
