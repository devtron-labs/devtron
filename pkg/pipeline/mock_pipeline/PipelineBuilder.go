...
func (m *MockPipelineBuilder) GetCdPipelinesForAppAndEnv(appId, envId int) (*bean0.CdPipelines, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCdPipelinesByAppIDAndEnvNameOrId", appId, envId)
	ret0, _ := ret[0].(*bean0.CdPipelines)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPipelineBuilderMockRecorder) GetCdPipelinesForAppAndEnv(appId, envId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCdPipelinesByAppIDAndEnvNameOrId", reflect.TypeOf((*MockPipelineBuilder)(nil).GetCdPipelinesForAppAndEnv), appId, envId)
}
