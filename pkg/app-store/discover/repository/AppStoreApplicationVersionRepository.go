...
type AppStoreApplicationVersionRepository interface {
	FindAll() ([]app_store_bean.AppStoreWithVersion, error)
	FindWithFilter(filter *app_store_bean.AppStoreFilter) ([]app_store_bean.AppStoreWithVersion, error)
	...
	FindByAppStoreName(name string) (*app_store_bean.AppStoreWithVersion, error)
...
func (impl *AppStoreApplicationVersionRepositoryImpl) FindAll() ([]app_store_bean.AppStoreWithVersion, error) {
	var appStoreWithVersion []app_store_bean.AppStoreWithVersion
...
func (impl *AppStoreApplicationVersionRepositoryImpl) FindWithFilter(filter *app_store_bean.AppStoreFilter) ([]app_store_bean.AppStoreWithVersion, error) {
	var appStoreWithVersion []app_store_bean.AppStoreWithVersion
...
func (impl *AppStoreApplicationVersionRepositoryImpl) FindByAppStoreName(name string) (*app_store_bean.AppStoreWithVersion, error) {
	var appStoreWithVersion app_store_bean.AppStoreWithVersion
...
func (impl *AppStoreApplicationVersionRepositoryImpl) SearchAppStoreChartByName(chartName string) ([]*app_store_bean.ChartRepoSearch, error) {
	var chartRepos []*app_store_bean.ChartRepoSearch
