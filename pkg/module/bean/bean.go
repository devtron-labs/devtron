...
type ModuleEnvConfig struct {
	...
	InstalledModules                      []string `env:"INSTALLED_MODULES" envDefault:"" envSeparator:"," description:"List of installed modules given in helm values/yaml are written in cm and used by devtron to know which modules are given"`
}
