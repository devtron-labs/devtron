...
type DeleteServiceEA interface {
...
type DeleteServiceEAImpl struct {
...
func NewDeleteServiceEAImpl(logger *zap.SugaredLogger,
...
func (impl DeleteServiceEAImpl) DeleteCluster(deleteRequest *cluster.ClusterBean, userId int32) error {
...
func (impl DeleteServiceEAImpl) DeleteEnvironment(deleteRequest *cluster.EnvironmentBean, userId int32) error {
...
func (impl DeleteServiceEAImpl) DeleteTeam(deleteRequest *team.TeamRequest) error {
