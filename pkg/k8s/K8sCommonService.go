...
func (impl *K8sCommonServiceImpl) GetResource(ctx context.Context, request *ResourceRequestBean) (*k8s.ManifestResponse, error) {
	...
	if err != nil {
		impl.logger.Errorw("error in getting resource", "err", err, "resource", resourceIdentifier.Name, "namespace", resourceIdentifier.Namespace)
		return nil, err
	}
	return resp, nil
}
...
func (impl *K8sCommonServiceImpl) ListEvents(ctx context.Context, request *ResourceRequestBean) (*k8s.EventsResponse, error) {
	...
	if err != nil {
		impl.logger.Errorw("error in listing events", "err", err, "resourceName", resourceIdentifier.Name)
		return nil, err
	}
