...
VALUES (1,(select id from chart_ref where version='1.2.0' and name='Deployment'), true, now(), 1, now(), 1),
(4,(select id from chart_ref where version='1.2.0' and name='Deployment'), true, now(), 1, now(), 1);
