...
INSERT INTO "public"."chart_ref" ("name","location", "version", "deployment_strategy_path","is_default", "active", "created_on", "created_by", "updated_on", "updated_by") VALUES
     ('Deployment','deployment-chart_4-20-0', '4.20.0','pipeline-values.yaml','t', 't', 'now()', 1, 'now()', 1);
...
VALUES (1,(select id from chart_ref where version='4.20.0' and name='Deployment'), true, now(), 1, now(), 1,true),
(4,(select id from chart_ref where version='4.20.0' and name='Deployment'), true, now(), 1, now(), 1,false);