...
(nextval('id_seq_plugin_step_variable'),(SELECT id FROM plugin_metadata WHERE name='Codacy'),'PickTokenFromGlobalConfigs','BOOL','Whether to use global token or not','t','f','t',null,'INPUT','NEW',null,1,null,null,'f','now()',1,'now()',1),
(nextval('id_seq_plugin_step_variable'),(SELECT id FROM plugin_metadata WHERE name='Codacy'),'API_TOKEN','STRING','API Toekn for the Codacy','t','t',null,null,'INPUT','NEW',null,1,null,null,'f','now()',1,'now()',1),
