...
VALUES (1,(select id from chart_ref where version='4.18.0' and name is null), true, now(), 1, now(), 1),
(2,(select id from chart_ref where version='4.18.0' and name is null), true, now(), 1, now(), 1),
(3,(select id from chart_ref where version='4.18.0' and name is null), true, now(), 1, now(), 1),
(4,(select id from chart_ref where version='4.18.0' and name is null), true, now(), 1, now(), 1);
