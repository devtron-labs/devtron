...
VALUES (nextval('id_seq_plugin_metadata'), 'Copy container image','Copy container images from the source repository to a desired repository','PRESET','','f', 'now()', 1, 'now()', 1);
