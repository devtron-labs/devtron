...
{{/* Check for app/release labels in customPodLabels and replace accordingly */}}
{{- define "customPodLabelsContainsApp" -}}
   {{- $LabelsContain := false -}}
   {{- if  hasKey .Values.customPodLabels "app" }}
          {{- $LabelsContain = true -}}
   {{- end }}
   {{- $LabelsContain -}}
{{- end -}}

{{- define "customPodLabelsContainsRelease" -}}
   {{- $LabelsContain := false -}}
   {{- if hasKey .Values.customPodLabels "release" }}
          {{- $LabelsContain = true -}}
   {{- end }}
   {{- $LabelsContain -}}
{{- end -}}