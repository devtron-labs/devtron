...
# Rollout Deployment Chart - v3.10
...
Helm Chart [json schema](../../../scripts/devtron-reference-helm-charts/reference-chart_3-10-0/schema.json) is used to validate the deployment template values.
